...
On any memory access, it saves the stride in a table associated to the PC. When it has more than two elements in the list with strides, it starts looking for patterns.
