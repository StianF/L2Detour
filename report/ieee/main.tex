...
\bibitem{dcptpaper}
M.~Grann\ae s, M.~Jahre and L.~Natvig, \emph{Multi-level Hardware Prefetching Using Low Complexity Delta Correlating Prediction Tables with Partial Matching }, 2010.
