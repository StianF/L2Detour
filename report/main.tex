...
The chosen benchmarks are a subset of CPU2000 which seems to be hard to
get good speedup ``for free'', making it especially worthwhile for academic
exploration since these workloads constitues a large potential for performance
gains.
